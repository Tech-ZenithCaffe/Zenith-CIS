  ...
  constructor() {
    super(
      [
        ...
        '      "conceptDescription": "Descrição do conceito",',
        '      "format": "stories" | "reels" | "carousel",',
        '      "businessGoal": "followers_growth" | "engagement" | "organic_reach"',
        "    }",
        "  ]",
        "}",
        "- Os valores de format e businessGoal DEVEM ser em inglês e minúsculos, exatamente como acima",
      ].join("\n"),
    );
  }
